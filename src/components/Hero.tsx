...
export default function Hero() {
  ...
  // Background moves slower than the page (classic parallax depth)
  const bgY = useTransform(scrollYProgress, [0, 1], ["0%", "22%"]);
  const bgScale = useTransform(scrollYProgress, [0, 1], [1, 1.12]);
  // Foreground content drifts up and fades slightly faster than the background
  ...
  return (
    ...
    >
      <motion.div style={{ y: bgY, scale: bgScale }} className="absolute inset-0">
        ...
        {/* layered depth: gradient, then a faint burgundy wash, then grain (via .grain) */}
      ...
      >
        ...
        {!prefersReducedMotion && (
          ...
          >
            <animateMotion dur="7s" begin="2.9s" repeatCount="indefinite" rotate="auto">
      ...
      <motion.div
        ...
        >
          Premium travel and group transportation for corporate events, grand weddings, family
          journeys and outstation getaways.
        </motion.p>
        ...
        >
          ...
          <GhostButton href="/fleet">Explore The Fleet</GhostButton>
        </motion.div>
        ...
        >
          <a href={`tel:${business.phoneDial}`} className="flex items-center gap-1.5 hover:text-gold">
